  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <div className="w-16 md:w-48 flex flex-col border-r border-separator bg-content1/20 shrink-0">
        ...
        <div className="mt-auto p-4 flex flex-col gap-2">
           <div className="hidden md:flex flex-col gap-0.5">
             <span className="text-[10px] uppercase font-bold text-muted-foreground/50 tracking-wider">Last Sync</span>
          ...
          >
            ...
            <RefreshIcon className={`w-4 h-4 md:ml-2 ${claudeUsage.loading || codexUsage.loading ? 'animate-spin' : ''}`} />
          </Button>
        </div>
      </div>
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <header
          data-tauri-drag-region
          className="h-14 flex items-center justify-between px-6 bg-background select-none shrink-0"
        >
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 custom-scrollbar">
          <div className="max-w-3xl mx-auto">
            ...
            {activeView === "scheduling" && (
              <SchedulingView claudeUsage={claudeUsage} codexUsage={codexUsage} />
            )}
          </div>
        </main>
      </div>
